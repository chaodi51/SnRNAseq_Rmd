---
title: "Ocular_snRNAseq_Macosko_etal_2015_dropseq_mouse_retina"
output:
  html_document:
    toc: true
    toc_float: true
...
setwd('~/Ocular_snRNAseq_publicdata_GRK1/mouse/Macosko_etal_2015_dropseq_mouse_retina')
set.seed(123)
```
...
# Load a compressed .txt.gz file
dt <- fread("GSE63472_P14Retina_merged_digital_expression.txt.gz")
df <- as.data.frame(dt)
...
retina <- CreateSeuratObject(counts = sparse_mat, project = "mouse_retina")
