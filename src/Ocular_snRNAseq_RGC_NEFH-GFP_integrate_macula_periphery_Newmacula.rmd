---
title: "Ocular_snRNAseq_RGC_NEFH-GFP_integrate_macula_periphery_Newmacula"
output:
  html_document:
    toc: true
    toc_float: true
...
New macula data has added. Integrate macula, periphery and the new new macula data datasets.
...
setwd('~/Ocular_snRNAseq_RGC_NEFH-GFP_Newmacula')
set.seed(123)
```
...
```{r, eval = FALSE}
# macula
rds_path1 <- list.files('../Ocular_snRNAseq_RGC_NEFH-GFP_macula/nf-core/output/cellranger/cellranger/mtx_conversions/',
...
# new macula
rds_path3 <- list.files('./nf-core/output/cellranger/cellranger/mtx_conversions/',
...
# combine samples
seuratObj <- merge(rds_list[[1]], y = rds_list[2:24], add.cell.ids = names(rds_list), project = "ocular_RGC_NEFH-GFP_integration")
# add sample names
...
# add groups
group <- ifelse(grepl("GTSAMPLE1051", seuratObj$sample), "macula",
...
#  [1] "GTSAMPLE1051-1" "GTSAMPLE1051-2" "GTSAMPLE1051-3" "GTSAMPLE1051-4" "GTSAMPLE1051-5" "GTSAMPLE1051-6" "GTSAMPLE1051-7"
#  [8] "GTSAMPLE1051-8" "GTSAMPLE1488-1" "GTSAMPLE1488-2" "GTSAMPLE1488-3" "GTSAMPLE1488-4" "GTSAMPLE1488-5" "GTSAMPLE1488-6"
# [15] "GTSAMPLE1488-7" "GTSAMPLE1488-8" "GTSAMPLE1539-1" "GTSAMPLE1539-2" "GTSAMPLE1539-3" "GTSAMPLE1539-4" "GTSAMPLE1539-5"
# [22] "GTSAMPLE1539-6" "GTSAMPLE1539-7" "GTSAMPLE1539-8"
...
## Integrate RGCs from Newmacula and periphery
```{r, eval = FALSE}
## Split object and SCTransform normalization  
RGC.list <- c(SplitObject(Newmacula_RGCs, split.by = "sample"), SplitObject(periphery_RGCs, split.by = "sample"))
...
# add groups
group <- ifelse(grepl("GTSAMPLE1539", RGC.integrated$sample), "Newmacula", "periphery")
...
#### markers from Kamil
genes <- c("NEFH", "SNCG", "NEFL", "SLC17A6", "THY1", "GFP")
VlnPlot(RGC.integrated, features = genes)
...
cluster_to_celltype <- c('0' = 'Midget OFF',  '1' = 'Midget ON', '2' = 'Other', 
    '3' = 'Other', '4' = 'Midget ON', '5' = "Parasol OFF", '6' = "Parasol ON", '7' = 'Other')
