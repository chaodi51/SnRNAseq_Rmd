---
title: "Ocular_snRNAseq_RGC_NEFH-GFP(macula)"
output:
  html_document:
    toc: true
    toc_float: true
...
setwd('~/Ocular_snRNAseq_RGC_NEFH-GFP_macula')
set.seed(123)
```
...
# combine samples
seuratObj <- merge(rds_list[[1]], y = rds_list[2:8], add.cell.ids = names(rds_list), project = "Ocular_RGC_NEFH-GFP_macula")
# add sample names
cells <- rownames(seuratObj@meta.data)

seuratObj$sample <- sub("(GTSAMPLE1051-[1-8]).*", "\\1", cells)
