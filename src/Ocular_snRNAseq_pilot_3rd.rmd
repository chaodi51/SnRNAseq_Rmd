---
title: "Ocular snRNAseq pilot dataset3"
output:
  html_document:
    toc: true
    toc_float: true
...
setwd('~/Ocular_snRNAseq_pilot_3rd')
set.seed(123)
```
...
# combine samples
seuratObj <- merge(rds_list[[1]], y = rds_list[2:4], add.cell.ids = names(rds_list), project = "ocular_pilot")
# add sample names
cells <- rownames(seuratObj@meta.data)

seuratObj$sample <- sub("(NHP-1_[1-4]).*", "\\1", cells)
```
