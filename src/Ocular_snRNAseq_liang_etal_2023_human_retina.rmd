---
title: "Ocular_snRNAseq_liang_etal_2023_human_retina"
output:
  html_document:
    toc: true
    toc_float: true
...
setwd('~/Ocular_snRNAseq_publicdata_GRK1/human/liang_etal_2023_human_retina')
set.seed(123)
```
...
```{r, eval = FALSE}
retina.data <- open_matrix_anndata_hdf5('liang_etal_2023_human_retina.h5ad')
write_matrix_dir(mat = retina.data, dir = 'liang_etal_2023_human_retina_counts')
retina.mat <- open_matrix_dir(dir = "liang_etal_2023_human_retina_counts")

retina.mat <- Azimuth:::ConvertEnsembleToSymbol(mat = retina.mat, species = "human")

m <- read.csv("liang_etal_2023_human_retina.metadata.csv", header=TRUE)
...
** too many cells,randomly choose 3 donors**
```{r, eval = FALSE}
...
set.seed(123)
selected <- c('19D013', '19D014', '19D016')
...
retina <- SCTransform(retina, method = "glmGamPoi", vst.flavor = "v2", verbose = TRUE)
...
rod_markers <- c("NT5E","DRAIC", "RHO", "ABCA4")
