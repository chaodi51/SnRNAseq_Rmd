---
title: "Ocular snRNAseq pilot dataset4"
output:
  html_document:
    toc: true
    toc_float: true
...
The 2nd dataset has more dead cells with high mitochondrial.
...
library(reshape2)
library(future)
options(future.globals.maxSize = 600 * 1024^2) # tested, use 600M
library(openxlsx)
library(patchwork)
library(HGNChelper)
library(httpgd)
...
setwd('~/Ocular_snRNAseq_pilot_4th')
set.seed(123)
```
...
seuratObj$sample <- sub("(GTSAMPLE02[789][0-9]).*", "\\1", cells)
```
