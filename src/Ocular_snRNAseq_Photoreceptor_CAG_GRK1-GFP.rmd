---
title: "Ocular_snRNAseq_Photoreceptor_CAG_GRK1-GFP"
output:
  html_document:
    toc: true
    toc_float: true
...
data.frame(sctype_scores %>% arrange(type, cluster))
...
## Photoreceptors ==========
```{r}
# more expressed in Rods in human
VlnPlot(sn, features = "GRK1")

# Rod markers
VlnPlot(sn, features = "RHO")
VlnPlot(sn, features = "ABCA4")

# Cone markers
VlnPlot(sn, features = "GRK7")
VlnPlot(sn, features = "ARR3")
