---
title: "Ocular_snRNAseq_li_etal_2023_human_retina"
output:
  html_document:
    toc: true
    toc_float: true
...
setwd('~/Ocular_snRNAseq_publicdata_GRK1/human/li_etal_2023_human_retina')
set.seed(123)
```
...
** too many cells,randomly choose 5 donors**
```{r, eval = FALSE}
...
set.seed(123)
# selected <- sample(unique(retina$sample), 5)
selected <- c('110814','19-D005','D009-13','D027-13')
...
rod_markers <- c("NR2E3","COL25A1", "RHO", "ABCA4")
