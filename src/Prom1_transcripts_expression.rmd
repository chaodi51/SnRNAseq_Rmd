---
title: "Transcripts expression for Prom1"
output:
  html_document:
    toc: true
    toc_float: true
...
# Abstract
Compare Prom1 isoforms expression among retina samples.
...
library(writexl)
library(DT)
setwd("/home/ubuntu/Ocular-Prom1-Isoform")
```
...
# filter isoforms
```{r}
ensembl_anno <- read_csv("transcripts-Summary-Homo_sapiens_Transcript_Summary_ENST00000447510.csv", show_col_types = FALSE)
