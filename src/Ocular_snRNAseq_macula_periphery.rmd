---
title: "Ocular_snRNAseq_macula_periphery"
output:
  html_document:
    toc: true
    toc_float: true
...
# Abstract
The first 3 samples are macula replicates and the second 3 are periphery replicates. 
We expect about 5k nuclear recovery/sample. The main goal of this experiment will be
to identify and assess the proportion of RGCs in each of the tissue regions.
...
setwd('~/Ocular_snRNAseq_macula_periphery')
set.seed(123)
```
...
seuratObj$sample <- sub("(GTSAMPLE100[67]_[1-3]).*", "\\1", cells)

#add groups
tissue_info <- ifelse(grepl("GTSAMPLE1006", seuratObj$sample), "macular", "periphery")
