---
title: "Ocular_snRNAseq_macula_periphery_Wunsorted"
output:
  html_document:
    toc: true
    toc_float: true
...
setwd('~/Ocular_snRNAseq_macula_periphery_Wunsorted/')
set.seed(123)
```
...
VlnPlot(sn, features = c("ENSMFAG00000036911", "SLC17A6", "SNCG","SYT2"), pt.size = 0.01, ncol=2, combine = TRUE)
